# Generated by Django 5.2.4 on 2025-08-02 02:24
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'permissions': [('can_manage_library', 'Can manage library details (add/edit/delete)')],
            },
        ),
        migrations.CreateModel(
            name='CustomUser',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('libraries', models.ManyToManyField(related_name='books', to='bookshelf.library')),
            ],
            options={
                'permissions': [('can_add_book', 'Can add a new book'), ('can_change_book', 'Can change existing books'), ('can_delete_book', 'Can delete books')],
            },
        ),
    ]
